...
const translations = {
    en: {
        ...
        content: {
            ...
            'strategy-1-desc': "Driving responsible, inclusive, and sustainable practices across our global operations.",
            'strategy-2-desc': "Building a resilient and sustainable supply chain that upholds human rights and environmental standards.",
            'strategy-3-desc': "Expanding access to technology and skills to empower people and communities worldwide.",
            'modalLabel1': "RISE Strategy Details",
            'modalLabel2': "Supply Chain Details",
            'modalLabel3': "Digital Equity Details",
            'modal-desc-1': "Our RISE strategy is built on the pillars of being Responsible, Inclusive, Sustainable, and Enabling. We aim to create a more responsible, inclusive, and sustainable world, enabled through our technology and the expertise and passion of our employees.",
    ...
    ar: {
        ...
        content: {
            ...
            'strategy-1-desc': "قيادة الممارسات المسؤولة والشاملة والمستدامة عبر عملياتنا العالمية.",
            'strategy-2-desc': "بناء سلسلة توريد مرنة ومستدامة تدعم حقوق الإنسان والمعايير البيئية.",
            'strategy-3-desc': "توسيع نطاق الوصول إلى التكنولوجيا والمهارات لتمكين الناس والمجتمعات في جميع أنحاء العالم.",
            'modalLabel1': "تفاصيل استراتيجية رايز (RISE)",
            'modalLabel2': "تفاصيل سلسلة التوريد",
            'modalLabel3': "تفاصيل العدالة الرقمية",
            'modal-desc-1': "تستند استراتيجية رايز (RISE) إلى ركائز التمتع بالمسؤولية، والشمول، والاستدامة، والتمكين. نحن نهدف إلى خلق عالم أكثر مسؤولية، وشمولاً، واستدامة، بتمكين من تقنيتنا وخبرة وشغف موظفينا.",
